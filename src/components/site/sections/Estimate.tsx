        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-2">
          <form onSubmit={onSubmit} className="rounded-3xl border border-border bg-white p-8 shadow-[var(--shadow-card)]">
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <Field label="Phone" id="phone"><Input id="phone" type="tel" required placeholder="(305) 555-1234" /></Field>
          ...
          <div className="flex flex-col gap-6">
            <div className="overflow-hidden rounded-3xl border border-border shadow-[var(--shadow-card)]">
              <iframe
                title="Voltline location"
                className="h-72 w-full"
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                src="https://www.openstreetmap.org/export/embed.html?bbox=-80.197%2C25.760%2C-80.187%2C25.770&layer=mapnik&marker=25.7651%2C-80.1917"
              />
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
              <InfoCard icon={Phone} title="Call Us" lines={["(305) 555-1234", "24/7 Emergency"]} />
              <InfoCard icon={Mail} title="Email" lines={["hello@voltline.com", "quotes@voltline.com"]} />
              <InfoCard icon={MapPin} title="Office" lines={["1450 Brickell Ave", "Miami, FL 33131"]} />
