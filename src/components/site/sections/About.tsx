...
const points = [
  "15+ years powering Miami residences and businesses",
    ...
    <section id="about" className="section-padding">
      <div className="mx-auto grid max-w-7xl items-center gap-16 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
        <div className="relative">
          ...
          <img
            src={aboutImg}
            alt="Voltline master electrician"
        ...
        <div>
          <span className="inline-flex rounded-full bg-primary/10 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-primary">About Voltline</span>
          ...
          <p className="mt-5 text-lg text-muted-foreground">
            From a single panel upgrade to a full commercial build-out, Voltline delivers
